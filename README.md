...
- **Reality target & server names**:
  ...
  - You can manually check the chosen domain by using:
      ...
      sudo docker run --rm ghcr.io/xtls/xray-core:latest tls ping <target-domain>
      ```
